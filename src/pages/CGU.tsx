...
const CGU = () => {
  return (
    <>
      <Helmet>
        <title>Conditions Générales d'Utilisation - ColisLink</title>
        <meta name="description" content="Conditions générales d'utilisation de ColisLink, plateforme de mise en relation pour l'envoi de colis entre la France et le Bénin." />
      </Helmet>
            ...
            <div className="prose prose-sm md:prose-base max-w-none">
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ColisLink est une plateforme de mise en relation entre voyageurs et expéditeurs souhaitant acheminer des colis entre la France et le Bénin. La plateforme ne transporte pas elle-même de colis et n'est en aucun cas responsable des échanges entre utilisateurs.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  L'accès ou l'utilisation de ColisLink implique l'acceptation sans réserve des présentes Conditions Générales d'Utilisation (CGU). Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ColisLink se réserve le droit de suspendre tout compte suspect, frauduleux ou inactif sans préavis.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>ColisLink facilite la mise en relation mais n'intervient pas dans la transaction</li>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-3">
                  ColisLink collecte uniquement les données nécessaires à l'usage du service : informations de profil, messages, annonces et avis.
                </p>
                <p className="text-muted-foreground leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ColisLink peut suspendre ou supprimer un compte en cas d'abus, fraude, non-respect des CGU, ou comportement nuisible à la communauté.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ColisLink se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés des modifications via l'application et/ou par email. L'utilisation continue du service après modification vaut acceptation des nouvelles conditions.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  ou à l'adresse : contact@colislink.com
                </p>
              </section>
