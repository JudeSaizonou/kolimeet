        ...
        >
          ...
          >
            ...
            <div style={{ padding: '28px 32px 28px' }}>
              <span style={{
                display: 'inline-flex',
                backgroundColor: trip.status === "open" ? '#8A38F5' : '#94a3b8',
                color: 'white',
                padding: '5px 12px',
                borderRadius: '16px',
                fontSize: '11px',
                ...
                {trip.status === "open" ? "✈️ DISPONIBLE" : "COMPLET"}
              </span>
            </div>
            ...
            <div style={{ padding: '0 32px 28px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <div style={{ flex: 1 }}>
                  ...
                  <h2 style={{ fontSize: '16px', fontWeight: '700', color: '#0f172a', margin: 0, lineHeight: 1.2 }}>{trip.from_city}</h2>
                  <p style={{ color: '#94a3b8', fontSize: '12px', marginTop: '2px' }}>{trip.from_country}</p>
                </div>
                ...
                <div style={{ flex: 1, textAlign: 'right' }}>
                  ...
                  <h2 style={{ fontSize: '16px', fontWeight: '700', color: '#0f172a', margin: 0, lineHeight: 1.2 }}>{trip.to_city}</h2>
                  <p style={{ color: '#94a3b8', fontSize: '12px', marginTop: '2px' }}>{trip.to_country}</p>
                </div>
              </div>
            </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-around', gap: '20px' }}>
                <div style={{ textAlign: 'center' }}>
                  <p style={{ fontSize: '28px', fontWeight: '700', color: '#0f172a', margin: 0, lineHeight: 1, letterSpacing: '-0.02em' }}>
                    {format(new Date(trip.date_departure), "d", { locale: fr })}
                  </p>
                  <p style={{ fontSize: '11px', color: '#64748b', marginTop: '6px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    {format(new Date(trip.date_departure), "MMM", { locale: fr })}
                  </p>
                </div>
                <div style={{ width: '1px', backgroundColor: '#e2e8f0' }} />
                <div style={{ textAlign: 'center' }}>
                  <p style={{ fontSize: '28px', fontWeight: '700', color: '#0f172a', margin: 0, lineHeight: 1, letterSpacing: '-0.02em' }}>{trip.capacity_available_kg}</p>
                  <p style={{ fontSize: '11px', color: '#64748b', marginTop: '6px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Kg dispo</p>
                </div>
                <div style={{ width: '1px', backgroundColor: '#e2e8f0' }} />
                <div style={{ textAlign: 'center' }}>
                  <p style={{ fontSize: '28px', fontWeight: '700', color: '#8A38F5', margin: 0, lineHeight: 1, letterSpacing: '-0.02em' }}>{trip.price_expect || trip.price_per_kg}€</p>
                  <p style={{ fontSize: '11px', color: '#64748b', marginTop: '6px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Par kg</p>
                </div>
              </div>
            </div>
